...
**Related:**
- [Policies & Cedar](/docs/policies-and-cedar) — the policy layer the templates compile into
- [Scopes & policies (concept)](/docs/concepts/scopes-and-policies) — the user-facing model
