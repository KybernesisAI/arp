...
<div className="mt-16 border-t border-rule pt-6 font-mono text-kicker uppercase tracking-[0.14em] text-muted">
  Source: <a href="https://github.com/KybernesisAI/arp/blob/main/docs/../rfcs/0002-connection-first-policy-model.md">docs/../rfcs/0002-connection-first-policy-model.md</a>
  {' · '}Ported 2026-04-23
</div>
