...
- [`0005-arp-as-an-a2a-extension`](./0005-arp-as-an-a2a-extension)
  — how an A2A v1.0 client discovers and addresses an ARP identity, with
  ARP riding as an A2A extension and the Connection Token as bearer.
  Accepted (implemented 2026-09).
...
<div className="mt-16 border-t border-rule pt-6 font-mono text-kicker uppercase tracking-[0.14em] text-muted">
  Source: <a href="https://github.com/KybernesisAI/arp/blob/main/docs/../rfcs/README.md">docs/../rfcs/README.md</a>
  {' · '}Ported 2026-04-23
</div>
