...
/**
 * Last-resort error boundary — fires when the root layout itself fails. The
 * design system is unreachable from here (the layout hasn't rendered), so
 * everything below is inline, unstyled except for a minimum of type + spacing
 * to stay legible.
 */
