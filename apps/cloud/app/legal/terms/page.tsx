  ...
  return (
    <>
      ...
      <Section title="1. Acceptance">
        <p>
          [DRAFT] By creating an account, installing the ARP sidecar, or
      ...
      <Section title="2. The Service">
        <p>
          [DRAFT] Kybernesis operates ARP Cloud, a hosted runtime for the
      ...
      <Section title="3. Accounts">
        <p>
          [DRAFT] You must provide accurate information, maintain the
      ...
      <Section title="4. Acceptable use">
        <p>
          [DRAFT] The following are prohibited without limitation:
        </p>
        <ul>
      ...
      <Section title="5. Fees + billing">
        <p>
          [DRAFT] Paid tiers are billed via Stripe. Prices + quotas are
      ...
      <Section title="6. Intellectual property">
        <p>
          [DRAFT] The ARP protocol specification, reference implementation,
      ...
      <Section title="7. Confidentiality">
        <p>
          [DRAFT] You agree to keep non-public information disclosed to you
      ...
      <Section title="8. Termination">
        <p>
          [DRAFT] Either party may terminate on notice. We may suspend or
      ...
      <Section title="9. Disclaimers">
        <p>
          [DRAFT] The Service is provided &ldquo;as is.&rdquo; Kybernesis
      ...
      <Section title="10. Limitation of liability">
        <p>
          [DRAFT] Aggregate liability is capped at the greater of (a) fees
      ...
      <Section title="11. Governing law">
        <p>
          [DRAFT] Governed by the laws of [TODO: counsel — jurisdiction
      ...
      <Section title="12. Changes">
        <p>
          [DRAFT] We may update these Terms; material changes will be
      ...
      <Section title="13. Contact">
        <p>
          [DRAFT] Questions: <code>legal@arp.run</code>.
        </p>
      </Section>
    </>
  );
