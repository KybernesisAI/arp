---
'@kybernesis/arp-resolver': minor
'@kybernesis/arp-tls': minor
'@kybernesis/arp-registry': minor
'@kybernesis/arp-audit': minor
'@kybernesis/arp-pdp': minor
'@kybernesis/arp-transport': minor
'@kybernesis/arp-runtime': minor
---

Phase 2 runtime core — seven new packages plus a reference agent binary.
