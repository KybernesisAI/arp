...
| 9 | Headless Integration + Public Launch | `docs/ARP-phase-9-launch.md` | **in flight** — 9a public sites (PR #19+#20), 9b cloud v2.1 endpoints + push register (PR #26), 9c rate limits + 3 testkit probes + Self.xyz fixture sweep + cookie-mock helper (PR #28), 9d WebAuthn + HKDF rotation + /api/tenants/rotate + /u/<uuid>/did.json dual-publish (in review), 9e pending |
