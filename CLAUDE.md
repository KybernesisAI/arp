...
| 9 | Headless Integration + Public Launch | `docs/ARP-phase-9-launch.md` | **in flight** — 9a public sites (PR #19+#20), 9b cloud v2.1 endpoints + push register (PR #26), 9c rate limits + 3 testkit probes + Self.xyz fixture sweep + cookie-mock helper, 9d-9e pending |
